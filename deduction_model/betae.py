...
class BetaE(IterativeModel):
    ...
    """
    def __init__(self, num_entities, num_relations, embedding_size = 500, num_layers = 2, gamma = 1, label_smoothing=0.0, session_encoder="SRGNN"):
        ...
        self.entity_embedding = nn.Embedding(num_entities  + 1, embedding_size * 2)
        nn.init.uniform_(
        ...
        session_encoder_config = {'node_count': num_entities, 'embedding_size': embedding_size * 2, 'step': 3}
        ...
        self.decoder = nn.Linear(embedding_size * 2,
                                 num_entities,
                                 bias=False)
...
if __name__ == "__main__":
    ...
    betae_model = BetaE(num_entities=nentity, num_relations=nrelation, embedding_size=embedding_size)
