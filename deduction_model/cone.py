...
class ConE(IterativeModel):
    ...
    """
    def __init__(self, num_entities, num_relations, alpha=150, gamma = 12, embedding_size = 800, label_smoothing=0.1, center_reg=0.02, drop=0., negative_size = 128,
                  use_old_loss = False, session_encoder="SRGNN"):
        ...
        self.entity_embedding = nn.Embedding(num_entities + 1, self.embedding_size) #axis embedding [num_entities, embedding_size](arg = 0)
        nn.init.uniform_(
...
if __name__ == "__main__":
    ...
    cone_model =ConE(num_entities=nentity, num_relations=nrelation, embedding_size=embedding_size,use_old_loss=False)
