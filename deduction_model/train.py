...
if __name__ == "__main__":
    ...
    if args.model != "nqe" and args.model != "gt" and args.model != "transformer" and args.model != "lstm" :
    ...
    if args.model == "transformer" or args.model == "biqe" or session_encoder == "TransRec" or args.model == "nqe" or args.model == "gt" or args.model == "lsgt" :
        ...
        for step in tqdm(range(total_step)):
            ...
            if args.model == "transformer" or args.model == "betae" or args.model == "cone" or \
                  args.model == "biqe" or session_encoder == "TransRec" or args.model == "nqe" or args.model == "gt" or \
                     args.model == "lsgt" or args.model == "q2b":
                scheduler.step()
